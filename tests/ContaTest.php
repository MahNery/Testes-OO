...
class ContaTest extends TestCase
{
    ...
    {
        $cpf = new CPF("422.585.642-58");
        static::assertEquals("422.585.642-58", $cpf->recuperaNumero());
    ...
    public function testTitularValido()
    {
        $marcelo = new Titular(new CPF("145.587.842-97"), "Marcelo");

        static::assertEquals("Marcelo", $marcelo->recuperaNome());
        static::assertEquals("145.587.842-97", $marcelo->recuperaCpf());
    }
    ...
    public function testTitularInvalido()
    {
        $this->expectException(\InvalidArgumentException::class);
        $this->expectExceptionMessage("Nome inválido. Insira mais de 5 caracteres.");

        $ana = new Titular(new CPF("145.587.842-97"), "Ana");
    }
}